...
import top from "../components/index/indexmain/top";
import contentmain from "../components/index/indexmain/contentmain";
import minjs from "../assets/js/jquery-1.8.3.min.js";
